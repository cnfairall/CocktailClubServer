...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CocktailClub.Models.CocktailIngredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("SavedCocktailId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CocktailClub.Models.CocktailIngredient", b =>
                {
                    b.HasOne("CocktailClub.Models.Ingredient", "Ingredient")
                        .WithMany("CocktailIngredients")
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CocktailClub.Models.SavedCocktail", "SavedCocktail")
                        .WithMany("CocktailIngredients")
                        .HasForeignKey("SavedCocktailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Ingredient");

                    b.Navigation("SavedCocktail");
                });
